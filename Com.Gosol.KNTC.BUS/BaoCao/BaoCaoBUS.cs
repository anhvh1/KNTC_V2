    ...
    public class BaoCaoBUS
    {
        ...
        public BaseResultModel TCD01(BaseReportParams p, string ContentRootPath, int RoleID, int CapID, int CoQuanDangNhapID, int CanBoDangNhapID, int TinhDangNhapID, int HuyenDangNhapID)
        {
            ...
            try
            {
                ...
                RowItem RowItem2 = new RowItem(2 + tmp, "1=4+13+22","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem3 = new RowItem(3 + tmp, "2=5+14+23", "", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem4 = new RowItem(4 + tmp, "3=6+7 +15+16 +24+25", "", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem5 = new RowItem(5 + tmp, "4","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem6 = new RowItem(6 + tmp, "5","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem7 = new RowItem(7 + tmp, "6","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem8 = new RowItem(8 + tmp, "7","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem9 = new RowItem(9 + tmp, "8", "", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem10 = new RowItem(10 + tmp, "9", "", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem11 = new RowItem(11 + tmp, "10","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem12 = new RowItem(12 + tmp, "11","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem13 = new RowItem(13 + tmp, "12","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem14 = new RowItem(14 + tmp, "13","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem15 = new RowItem(15 + tmp, "14","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem16 = new RowItem(16 + tmp, "15","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem17 = new RowItem(17 + tmp, "16","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem18 = new RowItem(18 + tmp, "17","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem19 = new RowItem(19 + tmp, "18","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem20 = new RowItem(20 + tmp, "19","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem21 = new RowItem(21 + tmp, "20","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem22 = new RowItem(22 + tmp, "21","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem23 = new RowItem(23 + tmp, "22","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem24 = new RowItem(24 + tmp, "23","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem25 = new RowItem(25 + tmp, "24","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem26 = new RowItem(26 + tmp, "25","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem27 = new RowItem(27 + tmp, "26","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem28 = new RowItem(28 + tmp, "27","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem29 = new RowItem(29 + tmp, "28","", "", null, "text-align: center;", ref DataArr);
                RowItem RowItem30 = new RowItem(30 + tmp, "29", "", "", null, "text-align: center;", ref DataArr);
        ...
        public BaseResultModel TongHopTinhHinhTCD_XL_GQD(BaseReportParams p, string ContentRootPath, IdentityHelper IdentityHelper)
        {
            ...
            try
            {
                ...
                TableHeader HeaderCol2 = new TableHeader(2, 0, "Tên cơ quan", "width: 215px", ref listTableHeader);
                ...
                TableHeader HeaderCol5 = new TableHeader(5, 0, "Giải quyết đơn", "", ref listTableHeader);     
                //Cấp 2
                var DataChild4 = new List<TableHeader>();
                TableHeader HeaderCol41 = new TableHeader(41, 4, "Trong hạn", "", ref DataChild4);
                TableHeader HeaderCol42 = new TableHeader(42, 4, "Quá hạn", "", ref DataChild4);
                TableHeader HeaderCol43 = new TableHeader(43, 4, "Tổng số", "", ref DataChild4);
                HeaderCol4.DataChild = DataChild4;

                var DataChild5 = new List<TableHeader>();
                TableHeader HeaderCol51 = new TableHeader(51, 5, "Tổng số", "", ref DataChild5);
                TableHeader HeaderCol52 = new TableHeader(52, 5, "Chưa giải quyết", "", ref DataChild5);
                TableHeader HeaderCol53 = new TableHeader(53, 5, "Đang giải quyết", "", ref DataChild5);
                TableHeader HeaderCol54 = new TableHeader(54, 5, "Đã giải quyết", "", ref DataChild5);
                TableHeader HeaderCol55 = new TableHeader(55, 5, "Đã ban hành QĐ", "", ref DataChild5);
                HeaderCol5.DataChild = DataChild5;
                //Cấp 3
                var DataChild53 = new List<TableHeader>();
                TableHeader HeaderCol531 = new TableHeader(531, 53, "Trong hạn", "", ref DataChild53);
                TableHeader HeaderCol532 = new TableHeader(532, 53, "Quá hạn", "", ref DataChild53);
                TableHeader HeaderCol533 = new TableHeader(533, 53, "Tổng số", "", ref DataChild53);
                HeaderCol53.DataChild = DataChild53;

                var DataChild55 = new List<TableHeader>();
                TableHeader HeaderCol521 = new TableHeader(541, 54, "K/n đúng", "", ref DataChild55);
                TableHeader HeaderCol522 = new TableHeader(542, 54, "K/n đúng 1 phần", "", ref DataChild55);
                TableHeader HeaderCol523 = new TableHeader(543, 54, "K/n sai", "", ref DataChild55);
